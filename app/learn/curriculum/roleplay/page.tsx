      ...
      <div className="mx-auto max-w-3xl">
        <div className="mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-6">
            Roleplay: Give It a Hat to Wear
          </h1>
          <p className="text-xl text-gray-600 leading-relaxed">
            The same question, asked by different personas, gets completely different answers.
          </p>
        </div>
        ...
        <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
          ...
          <div className="mt-16 pt-8 border-t border-gray-200 not-prose">
            <div className="flex justify-between">
              ...
              >
                ← Previous: Your Prompt is Everything
              </Link>
              <Link
                href="/learn/curriculum/examples"
                className="inline-flex items-center gap-2 text-gray-600 hover:text-gray-900 font-medium"
              >
                Next: Examples (Few-Shot Prompting) →
              </Link>
            </div>
          </div>
        </div>
