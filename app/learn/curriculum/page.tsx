...
const modules = [
  {
    ...
    lessons: [
      { title: 'LLMs Understand Language via Machine Learning', slug: 'llms-machine-learning', status: 'available' },
      { title: 'Pretrained on the Whole Internet', slug: 'pretraining-basics', status: 'available' },
      { title: 'Fine-Tuned to Be a Helpful Assistant', slug: 'finetuning-basics', status: 'available' },
      { title: 'There Is No Memory (Just One Long Prompt)', slug: 'no-memory', status: 'available' },
    ]
  },
  {
    id: 0.5,
    ...
    lessons: [
      {
        title: 'Your Prompt is the Entire Input', slug: 'prompt-is-everything', status: 'available', bullets: [
  ...
  },
  {
    ...
    lessons: [
      ...
      { title: 'How Information Flows Through Transformers', slug: 'how-llms-work', status: 'available' },
