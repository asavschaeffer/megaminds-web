      ...
      <div className="mx-auto max-w-3xl">
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            It's just one long prompt. Every single time.
          </p>
        </div>
        ...
        <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
          ...
          <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 my-8 not-prose">
            <div className="space-y-4">
              <div className="flex gap-3 items-start">
                ...
                <div>
                  <p className="text-gray-900 font-medium">Your prompt is everything</p>
              ...
              <div className="flex gap-3 items-start">
                ...
                <div>
                  <p className="text-gray-900 font-medium">Long chats degrade</p>
                  <p className="text-sm text-gray-600 mt-1">
              ...
              <div className="flex gap-3 items-start">
                ...
                <div>
                  <p className="text-gray-900 font-medium">You can edit history</p>
                  <p className="text-sm text-gray-600 mt-1">
              ...
              <div className="flex gap-3 items-start">
                ...
                <div>
                  <p className="text-gray-900 font-medium">New chat = clean slate</p>
                  <p className="text-sm text-gray-600 mt-1">
          ...
          <div className="mt-4 flex justify-between not-prose">
            <Link
              href="/learn/curriculum/finetuning-basics"
              className="inline-flex items-center gap-2 text-gray-600 hover:text-gray-900 font-medium"
            >
              ← Previous: Fine-Tuned to Be Helpful
            </Link>
            <Link
              href="/learn/curriculum/prompt-is-everything"
              className="inline-flex items-center gap-2 text-gray-600 hover:text-gray-900 font-medium"
            >
              Next Module: Prompting →
            </Link>
          </div>
        </div>
      </div>
...
function WhatYouSeeVsWhatItSees() {
