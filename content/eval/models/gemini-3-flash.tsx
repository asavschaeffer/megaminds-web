...
export const gemini3Flash: ModelProfile = {
  ...
  analysis: {
    strengths: [
      { claim: 'Blistering speed: up to 3x faster than predecessors with lower latency' },
      { claim: 'Native multimodality: reasons across text, image, video, and audio (81.2% MMMU Pro)' },
      { claim: 'Agentic excellence: strong on complex tasks (24.0% Apex-Agents, 78% SWE-bench)' },
      { claim: 'Massive 1M token context window with cost-effective context caching' },
      { claim: 'Superior economics: ~$0.50/1M tokens, 1/4th the price of Gemini 3 Pro' },
      { claim: 'Efficiency: ~30% fewer tokens for everyday queries versus older versions' },
    ],
    weaknesses: [
      { claim: 'Reliability gaps: hallucinations and inconsistent instruction adherence' },
      { claim: 'Attentional regressions: recall can drop exponentially in long, multi-turn chats' },
      { claim: 'Instruction adherence: occasionally overweights context or ignores explicit constraints' },
      { claim: 'Integration friction: unpolished dev UIs and undocumented rate limits' },
      { claim: 'Testing sensitivity: inconsistent behavior when it detects a benchmarking context' },
    ],
    unknowns: [
      { claim: 'Full architectural details (<GlossarySidenote term="MoE" /> suspected, ~1T total parameters)' },
      { claim: 'Long-term impact of "evaluation paranoia" on real-world stability' },
      { claim: 'Training data diversity and specific data sources' },
    ],
  },
  intro: {
    text:
