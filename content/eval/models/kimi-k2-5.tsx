...
export const kimiK25: ModelProfile = {
    ...
    analysis: {
        strengths: [
            { claim: 'Agent Swarm: spawns up to 100 parallel sub-agents for 4.5x faster tasks' },
            { claim: 'Ultra-low API pricing: $0.15/M tokens (cache hit) undercuts competitors by 10-20x' },
            { claim: 'Native multimodality with MoonViT encoder excels at visual coding and documents' },
            { claim: 'Open weights under Modified MIT License enable enterprise customization' },
            { claim: 'MoE efficiency: 1T total params but only 32B active per inference' },
        ],
        weaknesses: [
            { claim: 'Abstract math reasoning (AIME: 49-70%) significantly trails GPT-5.2 (100%)' },
            { claim: 'Hardware requirements prohibitive for local inference without enterprise resources' },
            { claim: 'Hallucination issues reported in Thinking mode beyond 32K context tokens' },
            { claim: 'Tool calling reliability lower than Claude in complex refactoring scenarios' },
        ],
        unknowns: [
            { claim: 'Long-term stability and support for open-weights releases' },
            { claim: 'Actual adoption rates in enterprise vs. hobbyist communities' },
            { claim: 'Comparative safety alignment with Western frontier models' },
        ],
    },
    intro: {
