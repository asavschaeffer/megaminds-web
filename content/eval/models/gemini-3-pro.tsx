...
export const gemini3Pro: ModelProfile = {
  ...
  analysis: {
    strengths: [
      { claim: 'State-of-the-art reasoning (91.9% GPQA Diamond, 95% AIME 2025)' },
      { claim: 'Native multimodality: processes text, image, video, and audio simultaneously' },
      { claim: 'Massive 1M token context window with solid retrieval for shorter ranges' },
      { claim: 'Agentic excellence: tops Vending-Bench 2 for planning and tool use' },
      { claim: 'Deep Google ecosystem integration (Workspace, Search, Vertex AI)' },
      { claim: 'Competitive pricing ($2/1M input) for a frontier class model' },
      { claim: 'Deep Think mode enables deliberate, chain-of-thought problem solving' },
    ],
    weaknesses: [
      { claim: 'Coding consistency is hit-or-miss; sometimes trails Claude Opus 4.5' },
      { claim: 'Long-context retrieval degrades significantly at full 1M scale (26.3% on MRCR v2)' },
      { claim: 'Prone to "mental" bugs: loops, self-deprecation, and evaluation paranoia' },
      { claim: 'Tool calling reliability improved but still behind GPT-5.x for strict schemas' },
      { claim: 'Multi-turn conversation quality can degrade over long sessions' },
    ],
    unknowns: [
      { claim: 'Full impact of "Deep Think" on real-world production latency' },
      { claim: 'Whether the "evaluation-paranoid" behavior can be trained out' },
      { claim: 'True parameter count (estimated >1T, but undisclosed)' },
    ],
  },
  intro: {
    text:
