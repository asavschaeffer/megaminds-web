...
export const claudeSonnet45: ModelProfile = {
  ...
  analysis: {
    strengths: [
      { claim: 'State-of-the-art tool calling and API integration for production systems' },
      { claim: 'Best-in-class coding: 82% on SWE-bench Verified with parallel test-time compute' },
      {
        claim: 'Native Computer Use: views screens, controls cursors, runs terminal commands',
        detail: '61.4% on OSWorld.',
      },
      { claim: 'Outstanding precision at identifying and articulating specific technical problems' },
      { claim: 'Extended thinking architecture enables complex multi-step reasoning' },
      { claim: '64k output token limit allows complete file generation in single passes' },
    ],
    weaknesses: [
      { claim: 'Premium pricing ($3/$15 per million tokens) compared to competitors' },
      { claim: 'Slower response times, especially when engaging extended thinking mode' },
      { claim: 'Limited free tier usage (restrictive for casual users)' },
      { claim: 'Context degradation ("poisoning") reported around 300k tokens in long sessions' },
      { claim: 'Automatic context compaction in long chats can lose important details' },
      { claim: 'Occasional performance regressions ("lazy" or "stupid" waves) reported by community' },
    ],
    unknowns: [
      { claim: 'Long-term reliability of multi-day autonomous agent runs in diverse environments' },
      { claim: 'True parameter count and mixture-of-experts architecture details remain undisclosed' },
      { claim: 'Impact of Constitutional AI training on edge cases and creative use cases' },
      { claim: 'Real-world adoption velocity versus marketing momentum' },
    ],
  },
  intro: {
    text:
